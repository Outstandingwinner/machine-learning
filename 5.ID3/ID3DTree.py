...
class ID3DTree(object):
    ...
    def predict(self,inputTree,featLabels,testVec): # 分类器
        ...
        root = inputTree.keys()[0]    # 树根节点    root = 'age'
        secondDict = inputTree[root]  # value-子树结构或分类标签 inputTree['age']
        featIndex = featLabels.index(root)  # 根节点在分类标签集中的位置 featLabels.index('age') =0
        key = testVec[featIndex] # 测试集数组取值 testVec['0'] ='0'
        valueOfFeat = secondDict[key] # secondDict[0]    inputTree['age']['0']

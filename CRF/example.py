...
def get_feature_functions(word_sets, labels, observes):
    ...
    print("tagval_functions=", tagval_functions)
    print("tagval_functions=", observation_functions)
    print("misc_functions=", misc_functions)
    print("transition_functions + tagval_functions + observation_functions + misc_functions",transition_functions + tagval_functions + observation_functions + misc_functions)
